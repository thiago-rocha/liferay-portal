...
module.exports = {
	ddlBundlePath: function(bundleName) {
		return path.resolve(appsDir, 'forms-and-workflow', 'dynamic-data-lists', bundleName);
	},
	...
	ddmBundlePath: function(bundleName) {
		return path.resolve(appsDir, 'forms-and-workflow', 'dynamic-data-mapping', bundleName);
	},
