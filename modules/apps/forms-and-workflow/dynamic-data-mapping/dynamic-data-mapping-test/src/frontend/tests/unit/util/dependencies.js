...
var soyDir = path.join(liferaySourceDir, 'modules', 'apps', 'foundation', 'frontend-js', 'frontend-js-soyutils-web');

var soyJSDir = path.join(osgi.resourcesMainPath(soyDir));

var frontendDir = path.join(liferaySourceDir, 'modules', 'apps', 'foundation', 'frontend-js', 'frontend-js-web');
...
var editorsDir = path.join(liferaySourceDir, 'modules', 'apps', 'foundation', 'frontend-editor');
