...
public class DDMFormRuleModelTranslatorTest {
	...
	protected void assertDisableRuleCondition1(JSONObject jsonObject) {
		Assert.assertTrue(jsonObject.has("operands"));
		Assert.assertTrue(jsonObject.has("operator"));

		Assert.assertEquals(
			"greater-than-equals", jsonObject.getString("operator"));
		...
		assertGetFunction(operand1, "Field1", "0");
	...
	protected void assertEnableAndVisibleRule(JSONArray jsonArray) {
		...
		assertEnableAndVisibleRuleCondition3(conditions.getJSONObject(2));
	...
	protected void assertEnableAndVisibleRuleCondition2(JSONObject jsonObject) {
		...
		Assert.assertEquals("greater-than", jsonObject.getString("operator"));
		...
		assertGetFunction(operand1, "Field2", "0");
	...
	protected void assertEnableAndVisibleRuleCondition3(JSONObject jsonObject) {
		Assert.assertTrue(jsonObject.has("operands"));

		JSONArray operands = jsonObject.getJSONArray("operands");

		Assert.assertEquals("equals", jsonObject.getString("operator"));
		Assert.assertEquals(2, operands.length());
		...
		assertGetFunction(operand2, "Field2", "0");
	}
	...
	protected void assertFunctionAsOperandFunction1(JSONObject jsonObject) {
		...
		assertGetFunction(parameter1, "Field1", "0");

		JSONObject parameter2 = parameters.getJSONObject(1);

		assertGetFunction(parameter2, "Field2", "0");

		JSONObject parameter3 = parameters.getJSONObject(2);

		assertGetFunction(parameter3, "Field3", "0");
	}
	...
	protected void assertHideRule(JSONArray jsonArray) {
		...
		assertHideRuleCondition1(condition);
	...
	protected void assertHideRuleCondition1(JSONObject jsonObject) {
		Assert.assertTrue(jsonObject.has("operands"));
		Assert.assertTrue(jsonObject.has("operator"));
	...
	protected void assertHideWithAndExpression(JSONArray jsonArray) {
		...
		assertHideWithAndExpressionCondition2(conditions.getJSONObject(1));
	...
	protected void assertHideWithAndExpressionCondition2(
		JSONObject jsonObject) {

		Assert.assertTrue(jsonObject.has("operands"));
		Assert.assertTrue(jsonObject.has("operator"));

		Assert.assertEquals("equals", jsonObject.get("operator"));
	...
	protected void assertShowRule(JSONArray jsonArray) {
		...
		assertShowRuleCondition1(condition);
	...
	protected void assertShowRuleCondition1(JSONObject jsonObject) {
		Assert.assertTrue(jsonObject.has("operands"));
		Assert.assertTrue(jsonObject.has("operator"));

		Assert.assertEquals(
			"less-than-equals", jsonObject.getString("operator"));
	...
	protected void assertShowRuleWithFunctionAsOperator(JSONArray jsonArray) {
		...
		assertShowRuleWithFunctionAsOperatorCondition1(
			conditions.getJSONObject(0));
	...
	protected void assertShowRuleWithFunctionAsOperatorCondition1(
		JSONObject jsonObject) {

		Assert.assertTrue(jsonObject.has("operands"));
		Assert.assertTrue(jsonObject.has("operator"));

		Assert.assertEquals("contains", jsonObject.getString("operator"));
	...
	protected void assertShowRuleWithOrExpression(JSONArray jsonArray) {
		...
		assertShowRuleWithOrExpressionCondition2(condition2);
	...
	protected void assertShowRuleWithOrExpressionCondition2(
		JSONObject jsonObject) {

		Assert.assertTrue(jsonObject.has("operands"));
		Assert.assertTrue(jsonObject.has("operator"));

		Assert.assertEquals("contains", jsonObject.get("operator"));
		...
		assertGetFunction(operand1, "Field3", "0");
	...
	protected void assertShowRuleWithOrExpressionFunction1(
		...
		Assert.assertEquals("equals", function.getString("name"));
