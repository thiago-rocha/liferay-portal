...
ddm.select = function(opt_data, opt_ignored) {
  ...
  for (var optionIndex51 = 0; optionIndex51 < optionListLen51; optionIndex51++) {
    ...
    output += '<option dir="' + soy.$$escapeHtml(opt_data.dir) + '" ' + soy.$$escapeHtml(optionData51.status) + ' value="' + soy.$$escapeHtml(optionData51.value) + '">' + soy.$$escapeHtml(optionData51.label) + '</option>';
  }
