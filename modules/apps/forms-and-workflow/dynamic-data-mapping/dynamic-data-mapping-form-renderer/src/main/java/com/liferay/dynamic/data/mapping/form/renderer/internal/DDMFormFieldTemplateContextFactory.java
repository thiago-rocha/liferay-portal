...
public class DDMFormFieldTemplateContextFactory {
	...
	protected List<Map<String, String>>
		createOptionsFromDDMFormEvaluationResult(
	...
	protected List<Map<String, String>> createOptionsFromDDMFormField(
	...
	protected void setDDMFormFieldTemplateContextOptions(
		...
		if (ListUtil.isEmpty(optionsList)) {
			ddmFormFieldTemplateContext.put(
				"options", createOptionsFromDDMFormField(ddmFormFieldOptions));
		}
		else {
			ddmFormFieldTemplateContext.put(
				"options",
				createOptionsFromDDMFormEvaluationResult(optionsList));
		}
	}
