			...
			function() {
				...
				it(
					...
					function(done) {
						...
						assert.isFalse(compareObject({B: '1'}, gridField.getValue()));
				...
				it(
					...
					function(done) {
						...
						assert.isFalse(compareObject({A: '1', C: '2'}, gridField.getValue()));

						assert.isObject(gridField.get('value'));

						assert.isTrue(compareObject(newValue, gridField.get('value')));

						assert.isFalse(compareObject({A: '1', C: '2'}, gridField.get('value')));
			...
			function() {
				...
				it(
					...
					function(done) {
						...
						assert.isFalse(compareObject({A: '1', B: '1'}, gridField.getValue()));
			...
			function() {
				it(
					...
					function(done) {
						...
						assert.isTrue(compareObject(gridField.getValue(), {A: '2'}));
				...
				it(
					...
					function(done) {
						...
						assert.isFalse(compareObject({A: '2'}, gridField.getValue()));

						assert.isTrue(compareObject({A: '1'}, gridField.getValue()));
