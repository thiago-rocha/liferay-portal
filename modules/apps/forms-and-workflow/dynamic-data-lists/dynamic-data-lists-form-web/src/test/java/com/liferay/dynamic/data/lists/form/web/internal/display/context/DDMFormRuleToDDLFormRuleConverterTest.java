...
public class DDMFormRuleToDDLFormRuleConverterTest {
	...
	@Test
	public void testMultipleActionsWithNumericCondition() {
		DDMFormRule ddmFormRule = new DDMFormRule(
			"TRUE",
			Arrays.asList("setVisible('Field2', getValue('Field1') > 2)", "setEnabled('Field3', getValue('Field1') > 2)", "setRequired('Field4', getValue('Field1') > 2)"));
		...
		expectedDDLFormRule.addDDLFormRuleAction(
			new DDLFormRuleAction("show", "Field2"));
		expectedDDLFormRule.addDDLFormRuleAction(
			new DDLFormRuleAction("enable", "Field3"));
		expectedDDLFormRule.addDDLFormRuleAction(
			new DDLFormRuleAction("require", "Field4"));
		expectedDDLFormRule.addDDLFormRuleConditions(
			new DDLFormRuleCondition(
				"greater-than",
				Arrays.asList(
