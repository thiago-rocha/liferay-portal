...
ddl.rule.condition = function(opt_data, opt_ignored) {
  return '<li class="form-builder-rule-condition-container-' + soy.$$escapeHtmlAttribute(opt_data.index) + '"><div class="card card-condition card-horizontal"><div class="card-row card-row-padded"><div class="card-col-content card-col-gutters"><div class="condition-if-' + soy.$$escapeHtmlAttribute(opt_data.index) + '"></div><div class="condition-operator-' + soy.$$escapeHtmlAttribute(opt_data.index) + '"></div><div class="condition-the-' + soy.$$escapeHtmlAttribute(opt_data.index) + '"></div><div class="condition-type-value-' + soy.$$escapeHtmlAttribute(opt_data.index) + '"></div><div class="condition-type-value-options-' + soy.$$escapeHtmlAttribute(opt_data.index) + '"></div></div><div class="card-col-field"><div class="dropdown"><a class="condition-card-delete icon-monospaced" data-card-id="' + soy.$$escapeHtmlAttribute(opt_data.index) + '" href="javascript:;">' + soy.$$filterNoAutoescape(opt_data.deleteIcon) + '</a></div></div></div></div></div>';
};
if (goog.DEBUG) {
