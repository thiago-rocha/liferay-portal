AUI.add(
		...
		var FormBuilder = A.Component.create(
			{
				...
				prototype: {
					...
					cancelFieldEdition: function(field) {
						...
						var fieldContext = fieldSettingsPanel._previousSettings;
					...
					getFieldSettingsPanel: function() {
						...
						if (!instance._sidebar) {
							instance._sidebar = instance._createFieldSettingsPanel();
						}
	...
	'',
	{
		requires: ['aui-form-builder', 'aui-form-builder-pages', 'aui-popover', 'liferay-ddl-form-builder-field-settings-modal', 'liferay-ddl-form-builder-field-settings-sidebar', 'liferay-ddl-form-builder-field-support', 'liferay-ddl-form-builder-field-type', 'liferay-ddl-form-builder-field-types-modal', 'liferay-ddl-form-builder-layout-deserializer', 'liferay-ddl-form-builder-layout-visitor', 'liferay-ddl-form-builder-pages-manager', 'liferay-ddl-form-builder-util', 'liferay-ddm-form-field-types', 'liferay-ddm-form-renderer']
	}
);